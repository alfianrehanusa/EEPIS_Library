        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="/buku/ebook">Ebook</a></li>
    ...
    <div class="container-fluid p-3 shadow-sm mb-5 bg-white rounded">
        <div class="row">
            <div class="col-8">
                ...
                <div class="row row-no-gutters">
                    <div class="col-3">
                        <h6 class="font-weight-bold">File Ebook</h6>
                    </div>
                    <div class="col-1 text-right pl-0 pr-0">
                        <h6>:</h6>
                    </div>
                    <div class="col">
                        <a class="btn btn-secondary btn-sm" href="/file/ebook/{{$data->ebook}}" target="_blank"><i class="fa fa-book-open mr-1"></i>Lihat file ebook</a>
                    </div>
                </div>
                <div class="row row-no-gutters">
                    <div class="col-3"></div>
