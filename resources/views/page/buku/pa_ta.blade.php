...
<div class="content-header ml-2 mr-2">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Buku Proyek Akhir/Tugas Akhir</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/">Home</a></li>
                    <li class="breadcrumb-item">Buku</li>
                    <li class="breadcrumb-item active">Proyek Akhir/Tugas Akhir</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <tbody>
                    @foreach ($data as $key)
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-sm btn-info" onclick="location.href='/buku/pa_ta/detail/{{$key->id}}';"><i class="fa fa-eye mr-1"></i>Detail</button>
...
@push('scripts')
    ...
    <script>
        ...
        function editBuku(id){
            ...
            $.post("/buku/pa_ta/read", {id: id}, function(data, status){
