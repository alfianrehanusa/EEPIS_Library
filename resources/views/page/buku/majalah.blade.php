...
<div class="content-header ml-2 mr-2">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Buku Majalah</h1>
            </div>
            <div class="col-sm-6">
                ...
                <tbody>
                    @foreach ($data as $key)
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-sm btn-info" onclick="location.href='/buku/majalah/detail/{{$key->id}}';"><i class="fa fa-eye mr-1"></i>Detail</button>
...
@push('scripts')
    ...
    <script>
        ...
        function editBuku(id){
            ...
            $.post("/buku/majalah/read", {id: id}, function(data, status){
