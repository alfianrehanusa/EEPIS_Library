...
<div class="content-header ml-2 mr-2">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Buku Ebook</h1>
            </div>
            <div class="col-sm-6">
                ...
                <tbody>
                    @foreach ($data as $key)
                        <tr>
                            ...
                            <td>{{$key->pengarang}}</td>
                            <td>
                                <button type="button" class="btn btn-sm btn-info mb-1" onclick="location.href='/buku/ebook/detail/{{$key->id}}';"><i class="fa fa-eye mr-1"></i>Detail</button><br>
            ...
            <form id="tambah_buku">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="judul" class="font-weight-normal">Judul Ebook :</label>
                    ...
                    <div class="form-group">
                        <label for="sinopsis" class="font-weight-normal">Sinopsis Ebook :</label>
                    ...
                    <div class="form-group">
                        <label for="ebook" class="font-weight-normal">File Ebook :</label>
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="ebook" name="ebook" accept="application/pdf" required>
                            <label class="custom-file-label" for="ebook">Pilih File Ebook</label>
                        </div>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script>
        ...
        function editBuku(id){
            ...
            $.post("/buku/ebook/read", {id: id}, function(data, status){
                ...
                message += '<div class="form-group"><label for="edit_tahun" class="font-weight-normal">Tahun Terbit :</label><input type="text" class="form-control" placeholder="Tahun Terbit" id="edit_tahun" name="edit_tahun" autocomplete="off" value="' + data.tahun + '" required></div></div>';
                ...
                message += '<div class="form-group"><label for="edit_ebook" class="font-weight-normal">File Ebook :</label><div class="custom-file"><input type="file" class="custom-file-input" id="edit_ebook" name="edit_ebook" accept="application/pdf"><label class="custom-file-label" for="edit_ebook">Pilih File Ebook</label></div><small class="form-text text-muted">Kosongkan jika tidak ingin merubah file ebook</small></div>';
